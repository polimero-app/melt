...
const messages: Record<Locale, Messages> = {
  en: {
    ...
    "control.unavailableDescription": "Melt cannot reach this printer right now. Check the printer connection and try again.",
    ...
    "control.awaitingDescription": "Melt is establishing the printer heartbeat. Telemetry appears as soon as a sample arrives.",
    ...
    "printersView.modelName": "Model name",
    ...
    "settingsView.slicerRemoveDescription": "This removes the slicer from Melt. The application itself is not affected.",
    ...
    "errors.keychainFailed": "Melt cannot access your system keychain, so it cannot read this printer’s access code. Unlock your keychain, then check it and retry the connection.",
  ...
  "pt-BR": {
    ...
    "control.unavailableDescription": "O Melt não consegue alcançar esta impressora no momento. Verifique a conexão da impressora e tente novamente.",
    ...
    "control.awaitingDescription": "O Melt está estabelecendo o heartbeat da impressora. A telemetria aparece assim que uma amostra chegar.",
    ...
    "printersView.modelName": "Nome do modelo",
    ...
    "settingsView.slicerRemoveDescription": "Isso remove o fatiador do Melt. O aplicativo em si não é afetado.",
    ...
    "errors.keychainFailed": "O Melt não consegue acessar o chaveiro do sistema e, por isso, não consegue ler o código de acesso desta impressora. Desbloqueie o chaveiro, verifique-o e tente conectar novamente.",
